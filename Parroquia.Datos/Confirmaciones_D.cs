...
namespace Parroquia.Datos
{
    public class Confirmaciones_D
    {
        ...
        public void InsertarConfirmacion(String nombreSP, List<Confirmaciones_E> lst)  // como parametro necesita el nombre del procedimiento almacenado y una lista generica que va a conetener parametros un array
        {
        ...
        public DataTable listado(String NombreSP, List<Confirmaciones_E> lst)
        {
