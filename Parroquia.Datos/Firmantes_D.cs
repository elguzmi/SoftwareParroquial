...
namespace Parroquia.Datos
{
    public class Firmantes_D
    {
        ...
        public void InsertarDefuncion(String nombreSP, List<Firmantes_E> lst)  // como parametro necesita el nombre del procedimiento almacenado y una lista generica que va a conetener parametros un array
        {
        ...
        public DataTable listado(String NombreSP, List<Firmantes_E> lst)
        {
