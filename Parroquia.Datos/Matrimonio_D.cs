...
{
    public class Matrimonio_D
    {

        CD_Conexion conexion = new CD_Conexion();


        public void InsertarMatrimonio(String nombreSP, List<Matrimonio_E> lst)  // como parametro necesita el nombre del procedimiento almacenado y una lista generica que va a conetener parametros un array
        {
        ...
        public DataTable listado(String NombreSP, List<Matrimonio_E> lst)
        {
