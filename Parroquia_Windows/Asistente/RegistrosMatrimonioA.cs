...
{
    public partial class RegistrosMatrimonioA : Form
    {
        ...
        private void DgvMatrimonios_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                CodigoPartida = int.Parse(DgvMatrimonios[0, DgvMatrimonios.CurrentRow.Index].Value.ToString());
